...
% ------------------------------------------------------------------
\newcommand{\TITLE}{Exploring the Influence of Working Agreements on Software Development Cycle Times}
\newcommand{\DATE}{December 30, 2022}

\newcommand{\FTITLE}{Yhteisten työskentelytapojen vaikutus ohjelmistokehityksen läpimenoaikoihin}
...
\newcommand{\FKEYWORDS}{ohjelmistokehitys, itseohjautuvat tiimit, työskentelytavat, prosessin läpimenoaika}
